                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('storage/' . $aboutus->person1_image) }}" class="img-thumbnail"
                                            width="60">
                                        <div>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="{{ asset('storage/' . $aboutus->person2_image) }}" class="img-thumbnail"
                                            width="60">
                                        <div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tagline" class="form-control" value="{{ $aboutus->tagline }}"
                                    required>
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Description</label>
                                <textarea name="description" class="form-control" rows="3" required>{{ $aboutus->description }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="person1_name" class="form-control"
                                        value="{{ $aboutus->person1_name }}" required>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Position</label>
                                    <input type="text" name="person1_position" class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $aboutus->person1_image) }}" class="img-thumbnail mt-2"
                                    width="80">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Name</label>
                                    <input type="text" name="person2_name" class="form-control"
                                        value="{{ $aboutus->person2_name }}" required>
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Position</label>
                                    <input type="text" name="person2_position" class="form-control"
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $aboutus->person2_image) }}" class="img-thumbnail mt-2"
                                    width="80">
                            </div>
