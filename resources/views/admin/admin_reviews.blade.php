...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn" data-bs-toggle="modal" data-bs-target="#createReviewModal"
                    ...
                    <tbody>
                        @forelse($reviews as $review)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/' . $review->img) }}" width="60" class="img-thumbnail">
                                </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $review->img) }}" width="80"
