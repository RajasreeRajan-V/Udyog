...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn" data-bs-toggle="modal" data-bs-target="#createCareerModal"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('admin.careers.destroy', $career->id) }}" method="POST"
                                        ...
                                        @csrf
                                        @method('DELETE')
                                        <button class="btn btn-sm btn-danger" onclick="return confirm('Delete this job?')">
                                            Delete
                                        </button>
                                    </form>
                                </td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="job_title" class="form-control"
                                    value="{{ $career->job_title }}" required>
                            </div>

                            <div class="mb-3">
                                <label>Salary Range</label>
                                <input type="text" name="salary_range" class="form-control"
                                    value="{{ $career->salary_range }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="skills" class="form-control" value="{{ $career->skills }}"
                                    required>
                            </div>
            ...
            <form action="{{ route('admin.careers.store') }}" method="POST">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Salary Range</label>
                            <input type="text" name="salary_range" class="form-control" placeholder="₹30K - ₹50K / Month"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            <label>Experience</label>
                            <input type="text" name="experience" class="form-control" placeholder="5+ Years Experience"
                                required>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="skills" class="form-control"
                                placeholder="Leadership, Granite Industry Knowledge" required>
                        </div>
