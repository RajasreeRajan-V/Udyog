...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn" data-bs-toggle="modal" data-bs-target="#createOfferModal"
                    ...
                    <tbody>
                        @forelse($offers as $offer)
                            <tr>
                                ...
                                <td>
                                    {{ $offer->valid_till ? \Carbon\Carbon::parse($offer->valid_till)->format('d M Y') : '-' }}
                                </td>
                                <td>{{ $offer->badge ?? '-' }}</td>
                                <td>
                                    <span
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="discount_text" class="form-control"
                                    value="{{ $offer->discount_text }}" required>
                            </div>

                            <div class="mb-3">
                                <label>Valid Till / Starting Date</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="badge" class="form-control" value="{{ $offer->badge }}">
                            </div>

                            <div class="mb-3">
                                <label>Type</label>
                                <select name="type" class="form-control" required>
                                    <option value="current" {{ $offer->type == 'current' ? 'selected' : '' }}>Current
                                    </option>
                                    <option value="upcoming" {{ $offer->type == 'upcoming' ? 'selected' : '' }}>Upcoming
                                    </option>
                                </select>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3" id="dateField">
                            <label id="dateLabel">Validity Date</label>
                            <input type="date" name="valid_till" id="validTill" class="form-control">
                        </div>

                        <div class="mb-3">
                            <label>Badge</label>
                            <input type="text" name="badge" class="form-control" placeholder="Hurry / Coming Soon">
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function updateLabel() {
                if (offerType.value === 'current') {
                    dateLabel.textContent = 'Validity Date';
                } else if (offerType.value === 'upcoming') {
                    dateLabel.textContent = 'Starting Date';
                }
            }

            // Run on change
            offerType.addEventListener('change', updateLabel);
