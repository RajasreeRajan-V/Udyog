...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn" data-bs-toggle="modal" data-bs-target="#createGalleryModal"
                    ...
                    <tbody>
                        @forelse($galleries as $gallery)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ asset('storage/' . $gallery->img) }}" width="60" class="img-thumbnail">
                                </td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="category" class="form-control" required>
                                    ...
                                    <option value="project" {{ $gallery->category == 'project' ? 'selected' : '' }}>Project
                                    </option>
                                    <option value="work_process"
                                        {{ $gallery->category == 'work_process' ? 'selected' : '' }}>Work Process</option>
                                    <option value="team" {{ $gallery->category == 'team' ? 'selected' : '' }}>Team
                                    </option>
                                    <option value="Celebrations"
                                        {{ $gallery->category == 'Celebrations' ? 'selected' : '' }}>Celebrations</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <img src="{{ asset('storage/' . $gallery->img) }}" width="80"
