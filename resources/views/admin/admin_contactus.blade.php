                                        ...
                                        <form action="{{ route('admin.contactus.reply', $contact->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <textarea name="replay" class="form-control" rows="6" required>{{ $contact->replay }}</textarea>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn"
                                                    style="background-color:#A0D25D; color:#3A3A3A;">
                                                    Send Reply
                                                </button>
                                            </div>
