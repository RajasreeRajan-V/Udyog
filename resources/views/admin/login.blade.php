        ...
        <div class="logo-wrapper">
            <div class="logo-emblem">
                ...
                <svg class="ring-outer" viewBox="0 0 148 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="74" cy="74" r="70" stroke="rgba(160,210,93,0.25)" stroke-width="1"
                ...
                <svg class="ring-inner" viewBox="0 0 124 124" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="62" cy="62" r="58" stroke="rgba(160,210,93,0.15)" stroke-width="0.5"
                        stroke-dasharray="2 6" />
                    <circle cx="62" cy="62" r="50" stroke="rgba(160,210,93,0.4)" stroke-width="1"
