        ...
        <div class="founder-story-section">
            ...
            <div class="story-images">
                ...
                <div class="founder-card" data-aos="fade-right">
                    <img src="{{ asset('storage/' . $about->person1_image) }}" alt="{{ $about->person1_name }}">
                    <div class="founder-info">
                        <h4>{{ $about->person1_name }}</h4>
                        <p>{{ $about->person1_position }}</p>
                    </div>
                </div>

                <!-- Person 2 -->
                <div class="founder-card" data-aos="fade-left" data-aos-delay="200">
                    <img src="{{ asset('storage/' . $about->person2_image) }}" alt="{{ $about->person2_name }}">
                    <div class="founder-info">
                        <h4>{{ $about->person2_name }}</h4>
                        <p>{{ $about->person2_position }}</p>
                    </div>
                </div>
            </div>
